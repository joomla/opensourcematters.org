...
/**
 * Same as default in Joomla 4.4.x but with misc information moved up to be under the main contact info
 * We remove the header for that section whilst we do it. We also remove the dd tags for it.
 */
