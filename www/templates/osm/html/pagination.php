...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="icon-fast-backward"></i>';
	}
	...
	{
		$display = '<i class="icon-fast-forward"></i>';
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled"><a><i class="icon-fast-backward"></i></a></li>';
	}
	...
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		return '<li class="disabled"><a><i class="icon-fast-forward"></i></a></li>';
	}
